        ...
        test_cases = [
            {
                ...
                'expected_result': 'CLM 기안 작성 기능 테스트',
                'result_status': 'Pass',
                'environment': 'dev',
                'deployment_date': date(2024, 1, 15),
            ...
            },
            {
                ...
                'pre_condition': '검토 완료',
                'expected_result': 'CLM 전자서명 기능 테스트',
                'result_status': 'Pass',
                'environment': 'dev',
                'deployment_date': date(2024, 1, 15),
                'folder_id': dev_deploy1.id,
            ...
            },
            {
                ...
                'expected_result': 'CLM 재무 검토 기능 테스트',
                'result_status': 'Pass',
                'environment': 'alpha',
                'deployment_date': date(2024, 1, 20),
            ...
            },
            {
                ...
                'pre_condition': 'ALPHA 환경 접속',
                'expected_result': 'CLM 법무 검토 기능 테스트',
                'result_status': 'Pass',
                'environment': 'alpha',
                'deployment_date': date(2024, 1, 20),
                'folder_id': alpha_deploy1.id,
            ...
            },
            {
                ...
                'expected_result': 'CLM 최종 승인 기능 테스트',
                'result_status': 'Pass',
                'environment': 'production',
                'deployment_date': date(2024, 1, 25),
            ...
            },
            {
                ...
                'pre_condition': 'PRODUCTION 환경 접속',
                'expected_result': 'CLM 도장 찍기 기능 테스트',
                'result_status': 'Pass',
                'environment': 'production',
                'deployment_date': date(2024, 1, 25),
                'folder_id': prod_deploy1.id,
